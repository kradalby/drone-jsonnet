...
[
  ...
  .withSteps(
    [
      fap.step.prettier_lint,
      fap.step.swift_lint,
      fap.step.swift_test(packages=packages, image='kradalby/swift:5.4-hirsute'),
      fap.step.swift_build(packages=packages, image='kradalby/swift:5.4-hirsute'),
      fap.step.swift_release(packages=packages,
                             name='munin',
                             image='kradalby/swift:5.4-hirsute'),
